/**
 * Created by PhilippMac on 18.01.17.
 */
/**
 * @license
...
export class XHRConnection implements Connection {
  ...
  constructor(req: Request, browserXHR: BrowserXhr, baseResponseOptions?: ResponseOptions) {
    this.request = req;
    this.response = new Observable<Response>((responseObserver: Observer<any>) => {
      ...
      const onProgress = (progress: ProgressEvent) => {
        responseObserver.next(new XhrProgress(progress.loaded, progress.total));
      };
 ...
 */
@Injectable()
export class CustomBackend implements ConnectionBackend {
